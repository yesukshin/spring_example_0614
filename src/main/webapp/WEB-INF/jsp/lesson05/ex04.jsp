...
<body>
  ...
  <h1>7.시작인덱스~종료인덱스까지 자르기 str2에서 치킨자르기</h1>
  ...
  <h1>10.글자의 공백을 모두 제거</h1>
  <c:set var="str3" value="  1  No pain  10  " />
  <pre>${str3}</pre>
